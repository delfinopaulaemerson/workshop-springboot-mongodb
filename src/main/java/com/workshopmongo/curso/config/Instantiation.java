...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 =  new Post(null, df.parse("21/003/2018"), "partiu viagem", "vou viajar a são paulo. abraços!",maria);
		Post post2=  new Post(null, df.parse("23/03/2018"), "Bom Dia", "acordei feliz hoje!",maria);
